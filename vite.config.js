    ...
    build: {
        rollupOptions: {
            input: {
                ...
                jadeSanctuaryIndex: resolve(__dirname, 'jade-sanctuary/index.html'),
                jadeSanctuaryPrivacy: resolve(__dirname, 'jade-sanctuary/privacy.html'),
                jadeSanctuarySupport: resolve(__dirname, 'jade-sanctuary/support.html'),
                jadeSanctuaryTerms: resolve(__dirname, 'jade-sanctuary/terms.html'),
